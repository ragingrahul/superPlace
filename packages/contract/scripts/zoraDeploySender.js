...
async function main() {
  ...
  const _mailbox = hyperlaneContract.zora.mailbox;
  const _interchainGasPaymaster = hyperlaneContract.zora.interchainGasPaymaster;
  ...
  fs.writeFileSync('zora-sender-address.json', JSON.stringify(contractAddress, null, 2));
}
